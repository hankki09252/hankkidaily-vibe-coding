...
let entries = load();
let state = {energy:7,mood:"괜찮아요",routines:[],training:"",learned:"",selfTalk:"",oneThing:"",oneThingDone:false,successList:blankSuccess(),gratitude:""};
